...
var boardnowTabName = "<%=nowTabName%>";	//현재 탭 이름
var board_tabArr = "<%=pop_tabArr%>";		//content tab array
var selBoardNum = "<%=selBoardNum%>";		//페이지 당 보여줄 객체 개수
board_tabArr = board_tabArr.split(",");
...
function boardViewDetail(obj){
	...
	var	contentDetailViewDialog = window.parent.jQuery.FrameDialog.create({
		url: '<c:url value="/geoCMS/board_viewer.do"/>?idxNum="' + bObjId + '"&viewPageNum="' + boardNowPageNum + '"&boardNowTab="'+ boardnowTabName+'"&selBoardNum='+$('#selBoardNum').val(),
		title: 'board Viewer',
		width: 960,
		height: 650,
		buttons: {},
