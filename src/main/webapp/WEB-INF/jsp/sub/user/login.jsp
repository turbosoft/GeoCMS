...
<div onclick="openLoginPage();" style="float: right;margin: 15px 60px; cursor: pointer;width:40px; height:20px; ">
	LOGIN
</div>
<div id="LoginDig">
	<table id='login_table' border=1 style="font-size: 13px;" width="100%;" class="loginCls">
		<tbody>
			<tr>
				<th>ID</th>
				<td>
